...
const ProfileCardWithBanner = ({ setProgress }) => {
  ...
  return (
    <>
      {user?.length === 0 ?
        (<div className="text-center my-3" style={{ minHeight: "70vh" }}>
          <h5 className="d-flex justify-content-center text-muted text-center my-4">Plese wait load your info..</h5>
