      ...
      <section id="pricing" className="bg-light py-5">
        <div className="container">
          ...
          <div className="text-center mb-4">
            <h2 className="display-4 fw-bold text-dark">Try With Latest Offers</h2>
            <p className="lead text-muted">Get New Offers</p>
          </div>
          ...
          <div className="row g-4">
            ...
            <div className="col-md-4">
              <div className="card border-light shadow-lg h-100">
            ...
            {/* Pro Plan */}
            <div className="col-md-4">
              <div className="card border-primary shadow-lg h-100 position-relative">
