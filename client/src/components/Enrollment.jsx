              ...
              <div className="card shadow-sm bg-white">
                <div className="card-body">
                  ...
                  <div className='position-relative'>
                    ...
                    />
                    <span className="play-cource-demo position-absolute bg-light shadow-sm cursor-pointer d-flex align-items-center shadow-sm py-2 px-4 rounded-2 border" onClick={() => { handlePlayVideo(course?.trialVideo) }}>
