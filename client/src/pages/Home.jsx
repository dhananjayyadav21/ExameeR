  ...
  return (
    <div>
      ...
      <section className='hero'>
        <section className='container-fluid container-lg mb-5 px-3 py-5'>
      ...
      <section className='container-fluid container-md px-4 my-5 home-banner-section'>
      ...
      <section className='container-fluid container-md px-4 my-5'>
        <div className='text-center'>
