...
const AnnouncementPage = () => {
    ...
    // Local state for users, selections, and form inputs
    ...
    // Validate and send the announcement
            ...
            <div className="serchContent-heroSection card my-4 shadow-sm">
                <div className="text-center py-4">
                    <h2 className="card-title">
                        📢 Send New <span className="serchContent-span-section text-info"> Announcement </span>
                    </h2>
