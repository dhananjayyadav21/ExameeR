            ...
            <div className="card h-100 border-0 shadow-sm transition-all hover-lift rounded-4 overflow-hidden bg-white">
                ...
                <div className="card-body p-4 d-flex flex-column">
                    <div className="d-flex justify-content-between align-items-center mb-3">
                        <span className="badge bg-primary-subtle text-primary px-2 py-1 rounded-2 fw-bold small text-uppercase ls-wide">{Course?.courseLevel}</span>
                        <div className="d-flex align-items-center text-muted small">
                            <i className="fa-regular fa-clock me-1"></i> {Course?.duration}
                        </div>
                    </div>
                    <h5 className="card-title fw-bold mb-2 line-clamp-2">{Course?.title}</h5>
