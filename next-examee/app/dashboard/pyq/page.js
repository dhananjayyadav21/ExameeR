    ...
    return (
        <div className="dc-page">
            ...
            <div className="dc-header">
                ...
                <Link href="/uploadPYQ" className="dc-add-btn" style={{ background: 'linear-gradient(135deg,#f59e0b,#d97706)', boxShadow: '0 4px 12px rgba(245,158,11,0.3)' }}>
                ...
                <form onSubmit={handleSubmit} className="row g-3 align-items-end">
                    <div className="col-md-5">
                        ...
                        <div className="dc-input-wrap">
                            ...
                            <input type="text" className="dc-input" placeholder="Year, subject, title..." value={search} onChange={e => setSearch(e.target.value)} />
                        </div>
                    </div>
                    ...
                    <div className="col-md-4">
                        <div className="d-flex gap-2">
                            ...
                            {(search || category !== 'sciTechnology' || status !== 'public') && (
                                <button type="button" className="dc-clear-btn" title="Clear Filters" onClick={() => { setSearch(''); setCategory('sciTechnology'); setStatus('public'); getPYQ(); }}>
