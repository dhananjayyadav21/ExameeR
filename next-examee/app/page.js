    ...
    <main>
          ...
          <section className='row rounded-4 p-md-4'>
            <div className='col-12 col-md-6 text-md-start px-lg-4 my-5'>
              ...
              <div className='d-flex my-4 gap-2 justify-content-center justify-content-md-start'>
                {!token ?
                  <><Link className='nav-link' href="/auth"><button type="button" className="btn btn-green px-4  rounded-3">Login</button></Link>
                    <Link className='nav-link' href="/auth"><button type="button" className="btn btn-green px-4 rounded-3">Register</button></Link>
                  </> :
            ...
            <div className='col-12 col-md-6 rounded-4 mb-4'>
              <img className='front-img' src="/assets/img/Front.png" alt="Front Examee" style={{ maxWidth: '100%', height: 'auto' }} />
            </div>
          </section>
      ...
      <section className='container-lg px-3 my-5 home-banner-section'>
        ...
        <div className='d-flex justify-content-center'>
          <button className='btn btn-dark px-5 py-2 mt-5' onClick={() => router.push('/cource')} >View All Courses</button>
        </div>
      </section>
        ...
        <div className='container-lg px-lg-5'>
          <div className='px-2 py-4 d-flex flex-column justify-content-center align-items-center'>
            ...
            <div className='mt-5 w-100'>
              <div className="row g-4">{team.map((t, index) => <Team key={index} profile={t.profile} name={t.name} role={t.role} description={t.description} />)}</div>
            </div>
          </div>
